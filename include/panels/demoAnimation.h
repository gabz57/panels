...
Panel *buildDemoAnimationPanel(const Font *font, int PANEL_WIDTH, int PANEL_HEIGHT, int LINE_HEIGHT, int LINE_WIDTH) {
    ...
    RotationTransformer *rotationTransformer4 = new RotationTransformer(360, 64, 64, 0);
    ...
    VerticalStretchingTransformer *verticalStretchingTransformer2 = new VerticalStretchingTransformer(0, 86, 128, true);
    ...
    TextLine *textLine2 = new TextLine("cityLine2", "Going down", "++", font, LINE_WIDTH, LINE_HEIGHT, 0, LINE_HEIGHT);
    ...
    RotationTransformer *rotationTransformer = new RotationTransformer(360, 16, 16, 0);
    ...
    RotationTransformer *rotationTransformer2 = new RotationTransformer(360, 64, 64, 0);
    ...
    RotationTransformer *rotationTransformer3 = new RotationTransformer(360, 0, 64, 0);
    AnimationComponent *animComponent4 = new AnimationComponent(panel, rotationTransformer3, 360, 60000);
